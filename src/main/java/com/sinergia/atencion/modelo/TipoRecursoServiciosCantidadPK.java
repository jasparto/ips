 ...
 * @author juliano
 */
public class TipoRecursoServiciosCantidadPK implements Serializable {
    ...
    public TipoRecursoServiciosCantidadPK() {
    }

    public TipoRecursoServiciosCantidadPK(int codInstitucion, int codEstablecimiento, Long codTipoRecurso, Long codServicio) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TipoRecursoServiciosCantidadPK)) {
            return false;
        }
        TipoRecursoServiciosCantidadPK other = (TipoRecursoServiciosCantidadPK) object;
    ...
    public String toString() {
        return "com.sinergia.atencion.modelo.TipoRecursoServiciosCantidadPK[ codInstitucion=" + codInstitucion + ", codEstablecimiento=" + codEstablecimiento + ", codTipoRecurso=" + codTipoRecurso + ", codServicio=" + codServicio + " ]";
    }
